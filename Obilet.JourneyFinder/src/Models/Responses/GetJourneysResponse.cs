...
public class GetJourneysResponse
{
    ...
    [JsonPropertyName("data")] public List<JourneyItem>? Data { get; set; }
...
public class JourneyItem
{
    ...
    [JsonPropertyName("partner-id")] public int? PartnerId { get; set; }

    [JsonPropertyName("partner-name")] public string? PartnerName { get; set; }

    [JsonPropertyName("route-id")] public int? RouteId { get; set; }

    [JsonPropertyName("bus-type")] public string? BusType { get; set; }

    [JsonPropertyName("bus-type-name")] public string? BusTypeName { get; set; }

    [JsonPropertyName("total-seats")] public int? TotalSeats { get; set; }

    [JsonPropertyName("available-seats")] public int? AvailableSeats { get; set; }

    [JsonPropertyName("journey")] public Journey Journey { get; set; }

    [JsonPropertyName("features")] public List<Feature>? Features { get; set; }

    [JsonPropertyName("origin-location")] public string? OriginLocation { get; set; }

    [JsonPropertyName("destination-location")]
    public string? DestinationLocation { get; set; }

    [JsonPropertyName("is-active")] public bool IsActive { get; set; }
    ...
    [JsonPropertyName("is-promoted")] public bool IsPromoted { get; set; }

    [JsonPropertyName("cancellation-offset")]
    public int? CancellationOffset { get; set; }

    [JsonPropertyName("has-bus-shuttle")] public bool HasBusShuttle { get; set; }

    [JsonPropertyName("disable-sales-without-gov-id")]
    public bool DisableSalesWithoutGovId { get; set; }

    [JsonPropertyName("display-offset")] public string? DisplayOffset { get; set; }

    [JsonPropertyName("partner-rating")] public double? PartnerRating { get; set; }
    ...
    [JsonPropertyName("branded-fares")] public List<object>? BrandedFares { get; set; }
    ...
    [JsonPropertyName("provider-id")] public int? ProviderId { get; set; }

    [JsonPropertyName("partner-code")] public string? PartnerCode { get; set; }

    [JsonPropertyName("provider-name")] public string? ProviderName { get; set; }
    ...
    [JsonPropertyName("markup-rate")] public double? MarkupRate { get; set; }
    ...
    [JsonPropertyName("markup-fee")] public double? MarkupFee { get; set; }

    [JsonPropertyName("generate-barcode")] public bool GenerateBarcode { get; set; }
    ...
    [JsonPropertyName("is-abroad-route")] public bool IsAbroadRoute { get; set; }
    ...
    [JsonPropertyName("transfer-count")] public int? TransferCount { get; set; }
    ...
    [JsonPropertyName("is-full-address")] public bool IsFullAddress { get; set; }
...
public class Journey
{
    ...
    [JsonPropertyName("original-price")] public decimal OriginalPrice { get; set; }

    [JsonPropertyName("internet-price")] public decimal InternetPrice { get; set; }

    [JsonPropertyName("provider-internet-price")]
    public decimal? ProviderInternetPrice { get; set; }

    [JsonPropertyName("booking")] public object? Booking { get; set; }

    [JsonPropertyName("bus-name")] public string? BusName { get; set; }
    ...
    [JsonPropertyName("available")] public object? Available { get; set; }

    [JsonPropertyName("partner-provider-code")]
    public string? PartnerProviderCode { get; set; }

    [JsonPropertyName("peron-no")] public string? PeronNo { get; set; }

    [JsonPropertyName("partner-provider-id")]
    public string? PartnerProviderId { get; set; }

    [JsonPropertyName("is-segmented")] public bool IsSegmented { get; set; }

    [JsonPropertyName("partner-name")] public string? PartnerName { get; set; }

    [JsonPropertyName("provider-code")] public string? ProviderCode { get; set; }

    [JsonPropertyName("sorting-price")] public double? SortingPrice { get; set; }
...
public class Stop
{
    ...
    [JsonPropertyName("is-segment-stop")] public bool IsSegmentStop { get; set; }
    ...
    [JsonPropertyName("map-url")] public object? MapUrl { get; set; }

    [JsonPropertyName("station-phone")] public object? StationPhone { get; set; }

    [JsonPropertyName("station-address")] public object? StationAddress { get; set; }
}

public class Policy
{
    [JsonPropertyName("max-seats")] public int? MaxSeats { get; set; }

    [JsonPropertyName("max-single")] public int? MaxSingle { get; set; }

    [JsonPropertyName("max-single-males")] public int? MaxSingleMales { get; set; }

    [JsonPropertyName("max-single-females")]
    public int? MaxSingleFemales { get; set; }

    [JsonPropertyName("mixed-genders")] public bool MixedGenders { get; set; }

    [JsonPropertyName("gov-id")] public bool GovId { get; set; }

    [JsonPropertyName("lht")] public bool Lht { get; set; }
}
...
public class Feature
{
    ...
    [JsonPropertyName("back-color")] public string? BackColor { get; set; }

    [JsonPropertyName("fore-color")] public string? ForeColor { get; set; }

    [JsonPropertyName("partner-notes")] public string? PartnerNotes { get; set; }
}